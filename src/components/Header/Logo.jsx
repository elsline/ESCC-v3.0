...
function Logo(props) {
  return (
    <>
      <a href="/" className="logo transition duration-[0.4s] lg:flex hidden ">
        <svg
          version="1.0"
          ...
          className={`w-50  transition duration-[0.4s] ${props.className}`}
        >
          <g
...
0 -21 -6 -20 -42z"
      ...
      <a href="/" className="logo transition duration-[0.4s] lg:hidden flex ">
        <svg
          version="1.0"
          xmlns="http://www.w3.org/2000/svg"
          width="80.000000pt"
